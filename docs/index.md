...
| [decisions.md](decisions.md) | *Warum* ist es so und nicht anders? — 15 Entscheidungen mit Begründung | wer etwas ändern will |
...
| [backlog.md](backlog.md) | Was fehlt noch? — nach Verwaltung, Besucher-Interface, Infrastruktur, Entwicklung | wer etwas aufgreifen will |
