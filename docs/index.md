...
| [decisions.md](decisions.md) | *Warum* ist es so und nicht anders? — 28 Entscheidungen mit Begründung | wer etwas ändern will |
...
| [backlog.md](backlog.md) | Was fehlt noch? — 25 Punkte nach Bereich, jeder mit Nummer, Art und Einordnung | wer etwas aufgreifen will |
