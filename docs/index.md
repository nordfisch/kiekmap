...
| [decisions.md](decisions.md) | *Warum* ist es so und nicht anders? — 29 Entscheidungen mit Begründung | wer etwas ändern will |
...
| [backlog.md](backlog.md) | Was fehlt noch? — 24 Punkte nach Bereich, jeder mit Nummer, Art und Einordnung | wer etwas aufgreifen will |
