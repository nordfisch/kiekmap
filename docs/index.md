...
| [decisions.md](decisions.md) | *Warum* ist es so und nicht anders? — 33 Entscheidungen mit Begründung | wer etwas ändern will |
...
| [backlog.md](backlog.md) | Was fehlt noch? — 21 Punkte nach Bereich, jeder mit Nummer, Art und Einordnung | wer etwas aufgreifen will |
